...
Проверяемые параметры: шрифт (Times New Roman, 14 пт), межстрочный интервал (1,5), отступ первой строки (1,25 см), поля страницы (3/1,5/2/2 см), выравнивание по ширине, заголовки (жирный, без точки), нумерация страниц, оглавление, подписи к рисункам/таблицам, список литературы, гиперссылки, цвет текста, пробелы, пустые строки, шрифт в таблицах.
